              ...
              <div className="rounded-lg border border-border/50 p-4">
                ...
                <div className="mt-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-2 px-4 bg-primary/20 hover:bg-primary/30 text-primary rounded-lg transition-colors"
              ...
              <div className="rounded-lg border border-border/50 p-4">
                ...
                <div className="flex gap-2">
                  {[12, 24, 36, 42, 48].map((number) => (
                    <div key={number} className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">
                      {number}
                    </div>
                  ))}
