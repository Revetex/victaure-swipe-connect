...
export function LotteryTabs({
  ...
  return <Tabs defaultValue="lotosphere" className="w-full">
      <TabsList className="w-full border border-[#64B5D9]/10 backdrop-blur-md rounded-xl p-1 bg-black">
        <TabsTrigger value="lotosphere" className={cn("flex items-center gap-2", "data-[state=active]:bg-[#64B5D9]/10", "data-[state=active]:text-[#64B5D9]", "rounded-lg transition-all duration-300", "hover:bg-[#64B5D9]/5")}>
          <Star className="h-4 w-4" />
          <span className="font-medium">Lotosphère</span>
        </TabsTrigger>
        <TabsTrigger value="chess" className={cn("flex items-center gap-2", "data-[state=active]:bg-[#64B5D9]/10", "data-[state=active]:text-[#64B5D9]", "rounded-lg transition-all duration-300", "hover:bg-[#64B5D9]/5")}>
      ...
      delay: 0.2
        ...
        <TabsContent value="lotosphere">
          <Card className="border-[#64B5D9]/10 backdrop-blur-md p-6 bg-black">
            ...
            <div className="grid gap-4">
              <div className="rounded-lg border border-[#64B5D9]/10 bg-white/5 p-4">
                ...
                <div className="mt-4">
                  ...
                  scale: 0.98
                }} className="w-full py-2 px-4 bg-[#64B5D9]/20 hover:bg-[#64B5D9]/30 text-[#64B5D9] rounded-lg transition-colors" onClick={() => onPaymentRequested(5, "Lotosphère")}>
                    Acheter un ticket (5 €)
                  </motion.button>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-[#64B5D9]/10 bg-white/5 p-4">
                ...
                <div className="flex gap-2">
                  {[12, 24, 36, 42, 48].map(number => <div key={number} className="w-10 h-10 rounded-full bg-[#64B5D9]/10 flex items-center justify-center text-[#64B5D9] font-bold">
                      {number}
                    </div>)}
