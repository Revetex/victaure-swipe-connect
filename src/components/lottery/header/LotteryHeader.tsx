...
export function LotteryHeader({
  ...
  return <div className="text-center space-y-4">
      <h1 className={cn("font-bold tracking-tight bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent", isMobile ? "text-xl" : "text-2xl sm:text-4xl")}>
