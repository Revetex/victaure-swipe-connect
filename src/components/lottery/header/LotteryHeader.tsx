  ...
  return <div className="relative space-y-6">
      ...
      <div className="relative z-10">
        ...
        delay: 0.2
          ...
          <h1 className={cn("text-center font-bold relative", "bg-gradient-to-b from-yellow-300 via-yellow-500 to-orange-500 bg-clip-text text-transparent", "drop-shadow-[0_2px_2px_rgba(0,0,0,0.5)]", isMobile ? "text-3xl" : "text-4xl sm:text-5xl")}>
            IMPERIUM
