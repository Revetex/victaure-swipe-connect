  ...
  return <motion.header initial={{
    ...
    paddingTop: 'env(safe-area-inset-top)'
      ...
      <div className="flex items-center gap-3">
        ...
        <Button onClick={() => setShowChat(true)} title="Assistant IA" className="group relative flex items-center gap-2 border border-[#64B5D9]/20 hover:border-[#64B5D9]/40 transition-all duration-300 shadow-lg shadow-black/20 bg-transparent font-thin text-base px-[8px] py-0 rounded-none">
          <motion.div initial={{
          scale: 1
        }} whileHover={{
          scale: 1.1
            ...
            <motion.div className="absolute -inset-1 bg-[#64B5D9]/20 rounded-full blur-md" animate={{
            opacity: [0.5, 0.7, 0.5],
            scale: [1, 1.2, 1]
          }} transition={{
            duration: 2,
