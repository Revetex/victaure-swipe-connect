  ...
  return <motion.header initial={{
    ...
    paddingTop: 'env(safe-area-inset-top)'
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="sm" onClick={handleMenuClick} className="lg:hidden text-white hover:bg-white/10 border border-white/10 active:scale-95 transition-transform touch-manipulation">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button onClick={() => setShowChat(true)} className="w-8 h-8 p-0 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 shadow-inner shadow-white/5 transition-all duration-200 touch-manipulation active:scale-95" title="Assistant IA">
