          ...
          <div className="w-full max-w-3xl mx-auto pb-4">
            <div className="grid md:grid-cols-[1fr,auto,auto] gap-2">
              <div className="relative">
                ...
                <Input type="text" placeholder="Rechercher un emploi, une entreprise..." className="h-10 pl-10 pr-4 w-full bg-white/5 border-white/10 text-white placeholder:text-white/40 focus:bg-white/10 transition-colors" />
              </div>
