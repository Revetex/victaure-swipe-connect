...
export function DashboardLayout() {
  ...
  return (
    <DashboardContainer containerVariants={containerVariants}>
      ...
      <motion.nav 
        className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-t border-border/50 transition-all duration-300 z-50"
        style={{ 
          height: 'auto',
