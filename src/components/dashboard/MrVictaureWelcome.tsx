...
export function MrVictaureWelcome({
  ...
  return <AnimatePresence>
      ...
      ease: "easeOut"
          ...
          <Card className="w-full max-w-3xl p-6 backdrop-blur-sm shadow-xl border border-[#64B5D9]/20 relative overflow-hidden bg-transparent px-[8px] py-[8px]">
            <Button variant="ghost" size="icon" onClick={handleDismiss} className="absolute right-2 top-2 text-gray-400 hover:text-gray-200 z-10">
              <X className="h-4 w-4" />
            </Button>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-4">
                ...
                repeat: Infinity
                  ...
                  <div className="flex-1">
                    ...
                    <div className="w-full bg-gray-700 h-1 mt-2 rounded-full overflow-hidden">
                      <motion.div className="h-full bg-[#64B5D9]" initial={{
              ...
              duration: 0.3
                  ...
                  {currentStep === 0 && <div className="grid gap-4 sm:grid-cols-2">
                      {[{
                  icon: UserCog,
                  ...
                  delay: index * 0.1
                }} className={cn("flex items-start gap-3 p-4 rounded-lg", "bg-white/5 hover:bg-white/10 transition-colors border border-white/5")}>
                ...
                <div className="flex justify-end gap-3">
                  <Button variant="outline" onClick={handleDismiss} className="hover:bg-red-500/10 hover:text-red-500 border-white/10 text-white/70">
                    Ignorer
                  </Button>
                  <Button onClick={handleNextStep} className="bg-[#64B5D9] hover:bg-[#64B5D9]/90 text-[#1E293B] group">
              ...
              <TabsContent value="demo" className="mt-6 bg-transparent">
                <div className="rounded-lg p-4 border border-white/10 bg-emerald-950">
                  ...
                  <div className="rounded p-3 text-white/80 whitespace-pre-line min-h-[200px] max-h-[250px] overflow-y-auto bg-transparent">
                    {aiResponse}
                ...
                <div className="mt-6 flex justify-end gap-3">
                  <Button variant="outline" onClick={handleDismiss} className="border-white/10 bg-emerald-950 hover:bg-emerald-800 text-white">
                    Plus tard
                  </Button>
                  <Button onClick={handleStartChat} className="group bg-emerald-950 hover:bg-emerald-800 text-white">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
              {Array.from({
            length: 20
          }).map((_, i) => <motion.div key={i} className="absolute w-2 h-2 rounded-full bg-[#64B5D9]" animate={{
