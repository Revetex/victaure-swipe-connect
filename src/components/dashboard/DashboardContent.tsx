...
export function DashboardContent({
  ...
  if (!user) {
    return <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-primary/5 via-background to-background">
        <motion.div initial={{
        scale: 0.8,
        opacity: 0
      }} animate={{
  ...
  const renderDashboardHome = () => {
    return <motion.div variants={containerVariants} initial="initial" animate="animate" exit="exit" className="container mx-auto p-8 space-y-10 max-w-7xl">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          <motion.div variants={itemVariants} className="glass-panel rounded-3xl shadow-2xl border border-primary/10 overflow-hidden relative group">
          ...
          <motion.div variants={itemVariants} className="md:col-span-2 lg:col-span-1 glass-panel rounded-3xl shadow-2xl border border-primary/10 overflow-hidden relative group">
        ...
        <AnimatePresence>
          {showFriendsList && <motion.div initial={{
          opacity: 0,
          scale: 0.95
        }} animate={{
          opacity: 1,
        ...
        {!isMobile && <motion.div variants={itemVariants} className="fixed bottom-8 right-8 flex gap-4">
