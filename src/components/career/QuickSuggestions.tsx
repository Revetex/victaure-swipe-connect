        ...
        {suggestions.map((suggestion, index) => {
          ...
          return (
            ...
            >
              <Button
                variant="ghost"
                className="w-full h-auto p-4 bg-gray-800/50 hover:bg-gray-700/50 text-left flex flex-col gap-2 items-start rounded-xl transition-all duration-200 group-hover:scale-105 group-hover:shadow-lg"
