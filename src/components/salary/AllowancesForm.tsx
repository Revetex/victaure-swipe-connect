...
export const AllowancesForm = ({ allowances, onAllowanceChange, expenses, onExpensesChange }: AllowancesFormProps) => {
  ...
  const handleDayChange = (type: AllowanceDayTypes, day: string, checked: boolean) => {
  ...
  const renderDayCheckboxes = (label: string, rate: number, icon: React.ReactNode, type: AllowanceDayTypes) => (
