...
export function AuthChat({
  ...
  return <div className="flex flex-col h-[500px] overflow-hidden bg-gradient-to-b from-[#1B2A4A]/50 to-[#1A1F2C]/50 rounded-xl border border-[#64B5D9]/10">
      <ChatHeader title="Assistant d'inscription" subtitle="Je peux vous aider avec le processus d'inscription" />
      
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        <MessageList messages={messages} isLoading={isLoading} />
      </div>

      <div className="p-4 space-y-4 bg-gradient-to-t from-[#1A1F2C] to-transparent py-0 px-0">
        <QuickSuggestions suggestions={suggestions} isLoading={isLoadingSuggestions} onSelect={suggestion => setUserInput(suggestion)} />
