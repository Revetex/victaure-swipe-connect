      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          <div className="flex flex-col items-center gap-6 mb-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/50 mb-2 font-playfair">
          ...
          >
            <Button
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground relative overflow-hidden group font-montserrat"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-primary text-primary hover:bg-primary/10 relative overflow-hidden group font-montserrat"
            >
