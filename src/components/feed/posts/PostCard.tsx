...
export function PostCard({
  ...
  return <div className="overflow-hidden text-[#F2EBE4] bg-black/40 rounded-lg border border-zinc-800/50 backdrop-blur-sm">
      ...
      {showComments && post.comments && <div className="border-t border-zinc-800/50">
