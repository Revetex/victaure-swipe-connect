  ...
  return <section className="backdrop-blur-md border border-[#64B5D9]/10 rounded-xl shadow-lg p-4 bg-transparent">
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <Input type="search" placeholder="Rechercher..." value={searchTerm} onChange={e => onSearchChange(e.target.value)} className="w-full pl-9 bg-white/5 border-white/10 text-white/90 
