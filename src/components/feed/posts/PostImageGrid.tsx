...
export const PostImageGrid = ({
  ...
  return <>
      ...
      <ImageViewer images={images.filter(img => !img.toLowerCase().endsWith('.pdf'))} initialIndex={selectedImageIndex || 0} isOpen={selectedImageIndex !== null} onClose={() => setSelectedImageIndex(null)} />
    </>;
};