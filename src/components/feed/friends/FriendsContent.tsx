...
export function FriendsContent() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] space-y-6">
      ...
      >
        <Card className="bg-white/30 dark:bg-black/20 backdrop-blur-md border border-[#64B5D9]/10 shadow-lg hover:shadow-xl transition-all duration-300 p-6">
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="relative">
            <ProfileSearch 
              ...
              className="w-full bg-white/50 dark:bg-black/50 backdrop-blur-md transition-all focus-within:bg-white/80 dark:focus-within:bg-black/80" 
            />
