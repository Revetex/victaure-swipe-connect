      ...
      <div className={cn("fixed top-0 left-0 right-0 z-50", "transition-all duration-300", headerVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4")}>
        <div className="bg-background/95 backdrop-blur-md border-b border-border/40 shadow-sm">
          <div className="container mx-auto max-w-4xl px-2 sm:px-4 py-2 space-y-2">
            {!isExpanded ? <Button onClick={() => setIsExpanded(true)} variant="ghost" className="w-full bg-primary/5 hover:bg-primary/10 text-foreground h-10 justify-start px-4 rounded-xl transition-all duration-200 border border-primary/10">
