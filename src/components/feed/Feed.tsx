...
export function Feed() {
  ...
  return <div className="fixed inset-0 bg-[#1A1F2C] overflow-hidden">
      ...
      <div ref={scrollRef} className="relative z-10 h-full overflow-y-auto scrollbar-thin scrollbar-thumb-[#64B5D9]/10 scrollbar-track-transparent hover:scrollbar-thumb-[#64B5D9]/20" style={{
        ...
        <div className="w-full max-w-3xl mx-auto px-4 space-y-6 py-0 sm:px-0">
          ...
          scale: headerScale
            ...
            duration: 0.4
              ...
              <CreatePostForm newPost={newPost} onPostChange={setNewPost} privacy={privacy} onPrivacyChange={setPrivacy} attachments={attachments} isUploading={isUploading} onFileChange={() => {}} onRemoveFile={() => {}} onCreatePost={invalidatePosts} onClose={() => {}} />
            </motion.div>
          </motion.div>
          ...
          delay: 0.2
            ...
            <div className="bg-[#1B2A4A]/30 backdrop-blur-sm border border-[#64B5D9]/10 rounded-xl overflow-hidden shadow-lg">
              <PostList onPostDeleted={invalidatePosts} onPostUpdated={invalidatePosts} />
            </div>
          </motion.div>
        </div>
      </div>
