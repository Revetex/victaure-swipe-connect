  ...
  return (
    <Elements stripe={stripePromise} options={stripeElementsOptions}>
      <ScrollArea className="h-[calc(100vh-5rem)] w-full">
        <div className="max-w-4xl mx-auto px-4 py-8 bg-[#1A1F2C]/50">
          <motion.div 
          ...
          >
            {settingsSections.map(({ id, Component }, index) => (
              ...
              >
                <Card className="bg-[#1B2A4A]/50 backdrop-blur border-[#64B5D9]/10 shadow-xl hover:shadow-purple-500/5 transition-all duration-300 p-6">
                  <Component />
                </Card>
              </motion.div>
            ))}
