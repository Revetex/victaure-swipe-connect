...
export function JobsSearch({
  ...
  return (
    <Card className="bg-background dark:bg-[#1B2A4A]/50 backdrop-blur-sm border-border/10 dark:border-[#64B5D9]/10 shadow-lg p-6 px-[8px] py-[8px]">
      <div className="flex flex-col gap-6">
                ...
                <div className="grid gap-6">
                  ...
                  <DialogFooter className="flex justify-end gap-2 pt-6">
                    <DialogClose asChild>
                      <Button 
                        variant="outline" 
                        className="h-12 px-6 bg-white hover:bg-gray-50 dark:bg-[#1B2A4A] dark:hover:bg-[#2A3B61] border-input/20 dark:border-[#64B5D9]/10"
        ...
        >
          <Input
            className="h-12 pl-10 pr-4 bg-white dark:bg-[#1B2A4A]/70 border-input/20 dark:border-[#64B5D9]/10"
