      ...
      <div className="relative group">
        ...
        <div className="bg-white/10 dark:bg-[#1B2A4A]/60 backdrop-blur-xl p-8 rounded-2xl border border-white/20 dark:border-[#D3E4FD]/20 shadow-[0_8px_32px_rgba(0,0,0,0.12)] relative overflow-hidden">
          ...
          <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="relative z-10">
            <TabsList className="grid w-full grid-cols-3 bg-[#1B2A4A]/20 rounded-xl p-1 mb-6">
              <TabsTrigger 
                value="login"
                className="rounded-lg px-4 py-2.5 text-[#F1F0FB]/80 data-[state=active]:bg-[#64B5D9] data-[state=active]:text-white data-[state=active]:shadow-sm transition-all duration-200 hover:text-white"
              >
                Connexion
              </TabsTrigger>
              <TabsTrigger 
            ...
            <TabsContent value="login" className="mt-0 space-y-6">
              <LoginForm 
                ...
                onEmailChange={value => setFormData(prev => ({
                  ...prev,
                  email: value
                }))} 
