...
export function AssistantMessage({ chatMessages, onSelectConversation }: AssistantMessageProps) {
  return (
    <motion.div
      ...
      className="group relative p-4 rounded-lg cursor-pointer transition-all duration-200 hover:scale-[1.02] bg-card hover:bg-card/80 border shadow-sm hover:shadow-md sticky top-0 z-10"
    >
