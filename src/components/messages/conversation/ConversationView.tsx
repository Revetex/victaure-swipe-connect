...
export function ConversationView({
  ...
  return (
    <section className="flex flex-col h-[calc(100vh-4rem)] sm:h-[calc(100vh-8rem)] overflow-hidden relative bg-background">
      ...
      <footer className="absolute bottom-0 left-0 right-0 bg-background/95 backdrop-blur border-t z-[48] pb-safe">
        <div className="p-4">
          <ChatInput
            value={inputMessage}
