...
export function ConversationView({
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-background">
      <div className="pt-16"> {/* Add padding top to account for the app header */}
        <div className="sticky top-16 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
          <ChatHeader
