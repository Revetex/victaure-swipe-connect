...
export function ConversationMessages({
  ...
  return <div ref={containerRef} className={cn("flex flex-col h-full relative", className)} onScroll={handleScroll}>
      <div className="flex-1 overflow-y-auto px-4 pb-20">
        <div className="max-w-3xl mx-auto py-4 space-y-4">
          {uniqueMessages.map(message => <motion.div key={message.id} initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
