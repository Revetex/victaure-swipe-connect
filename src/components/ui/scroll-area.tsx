...
const ScrollBar = React.forwardRef<React.ElementRef<typeof ScrollAreaPrimitive.ScrollAreaScrollbar>, React.ComponentPropsWithoutRef<typeof ScrollAreaPrimitive.ScrollAreaScrollbar>>(({
  ...
  ...props
    ...
    <ScrollAreaPrimitive.ScrollAreaThumb className={cn("relative flex-1 rounded-full", "bg-zinc-200/50 dark:bg-zinc-700/50", "hover:bg-zinc-300/50 dark:hover:bg-zinc-600/50", "transition-colors")} />
