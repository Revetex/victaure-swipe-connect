...
export default function Auth() {
  ...
  return <div className="relative min-h-screen flex flex-col bg-[#0B1026] overflow-hidden">
      ...
      <div className="fixed inset-0">
        ...
        {/* Nébuleuse */}
        <motion.div className="absolute inset-0 bg-gradient-to-r from-[#64B5D9]/5 via-[#9B6CD9]/5 to-[#64B5D9]/5" animate={{
        scale: [1, 1.1, 1],
        opacity: [0.3, 0.4, 0.3]
      }} transition={{
        duration: 20,
        ...
        {/* Étoiles filantes */}
        {[...Array(3)].map((_, i) => <motion.div key={i} className="absolute h-[1px] w-[100px] bg-gradient-to-r from-transparent via-white to-transparent" animate={{
        x: ['-100%', '200%'],
        y: ['0%', '100%'],
        opacity: [0, 1, 0]
      }} transition={{
        ...
        duration: 0.5
          ...
          <div className="space-y-4 sm:space-y-6">
            <Suspense fallback={<div className="flex justify-center">
              ...
              {isChatVisible && <motion.div initial={{
              opacity: 0,
              scale: 0.95
            }} animate={{
              opacity: 1,
              scale: 1
            }} className="relative w-full max-w-sm sm:max-w-md mx-auto" transition={{
              duration: 0.3
            }}>
                  <div className="absolute inset-0 bg-gradient-to-br from-[#221F26]/50 to-[#1A1F2C]/50 blur-xl" />
                  <div className="relative backdrop-blur-md border border-[#64B5D9]/20 p-3 sm:p-4 shadow-lg overflow-hidden hover:border-[#64B5D9]/30 transition-all duration-300 bg-transparent py-0 px-0 rounded-sm">
                    <VictaureChat maxQuestions={3} onMaxQuestionsReached={() => {
